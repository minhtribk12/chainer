...
def main():
    ...
    # Set up a trainer
    updater = training.StandardUpdater(train_iter, optimizer, device=args.mic)
    trainer = training.Trainer(updater, (args.epoch, 'epoch'), out=args.out)

    # Evaluate the model with the test dataset for each epoch
    ##trainer.extend(extensions.Evaluator(test_iter, model, device=args.mic))
    ...
    with open("/home/minhtri/workspace/chainer_modified/workspace/log/log1.txt","a") as file_log: 
